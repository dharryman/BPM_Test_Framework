...
# Tests.Fixed_amplitude_fill_pattern_test(RF, BPM, GS, dls_RF_frequency, final_power, samples, bunch_length, settling_time, report, sub_directory)
# Tests.Scaled_amplitude_fill_pattern_test(RF, BPM, GS, dls_RF_frequency, final_power, samples, bunch_length, settling_time, report, sub_directory)
